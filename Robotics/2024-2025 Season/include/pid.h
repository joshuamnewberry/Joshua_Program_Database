...
namespace PID
{
    ...
    void drive(double driveTarget)
    {
        ...
        double targetL = odom.getLeftEncoder() + (driveTarget * inchToDegreeConverter);
        double targetR = odom.getRightEncoder() + (driveTarget * inchToDegreeConverter);
    ...
    void goTo(double endingX, double endingY)
    {
        ...
        // face the end point.
        double turnAngle = atan((endingX - startingX) / (endingY - startingY)) * 180 / M_PI;
